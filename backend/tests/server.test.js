...
// Test database setup
beforeAll(async () => {
  const mongoUri = process.env.MONGODB_TEST_URI || 'mongodb://localhost:27017/quiz-generator-test';
...
describe('Quiz Results API', () => {
  ...
  describe('POST /api/results', () => {
    ...
    it('should handle database errors gracefully', async () => {
      ...
      await mongoose.connect(process.env.MONGODB_TEST_URI || 'mongodb://localhost:27017/quiz-generator-test');
    });
  });
